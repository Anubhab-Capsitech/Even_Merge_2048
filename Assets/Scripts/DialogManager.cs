...
public class DialogManager : MonoBehaviour
{
	...
	public void show(GameObject obj, bool isIgnoreBack = false)
	{
		...
		//PersistentAudioManager.Instance.PlayEffect("sound_eff_happywingame");
	}
	...
	public void Close(Action callfunc = null)
	{
        ...
        _dialogData.child.transform.DOKill(false);
		DOTween.Kill(_dialogData.parent, false);
		UnityEngine.Object.Destroy(_dialogData.parent);
		if (callfunc != null)
		{
			callfunc();
		}
