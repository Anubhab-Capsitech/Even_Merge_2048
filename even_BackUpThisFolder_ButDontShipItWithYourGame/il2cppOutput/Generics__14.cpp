...
IL_0009:
	...
	try
	{
		...
		try
		{
			int32_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mAE0A06EC5B926430F136A7C53C6C039591152462(__this, L_3, ((*(int32_t*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 16)))), il2cpp_rgctx_method(method->klass->rgctx_data, 53));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
